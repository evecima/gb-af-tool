...
const CACHE='oncall-maintenance-v0-7-16';
const V='?v='+VERSION;
...
const CORE=['./','./index.html','./print.html'+V,...styles,'./vendor/html2canvas.min.js'+V,'./vendor/jspdf.umd.min.js'+V,...ui,...seeds,...numbered('app',47),'../apartments.js'+V,'./manifest.webmanifest'+V,'./icons/icon.svg'+V];
