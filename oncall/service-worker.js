...
const CACHE='oncall-maintenance-v0-7-11-reportable-master-sync';
const V='?v='+VERSION;
...
const CORE=['./','./index.html','./print.html'+V,...styles,'./vendor/html2canvas.min.js'+V,'./vendor/jspdf.umd.min.js'+V,...ui,...seeds,...numbered('app',42),'../apartments.js'+V,'./manifest.webmanifest'+V,'./icons/icon.svg'+V];
