const VERSION='0.7.7';
const CACHE='oncall-maintenance-v0-7-7-master-emergency-titles';
const V='?v='+VERSION;
...
const CORE=['./','./index.html','./print.html'+V,...styles,'./vendor/html2canvas.min.js'+V,'./vendor/jspdf.umd.min.js'+V,...ui,...seeds,...numbered('app',38),'../apartments.js'+V,'./manifest.webmanifest'+V,'./icons/icon.svg'+V];
