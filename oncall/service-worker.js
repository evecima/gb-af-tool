...
const CORE=['./','./index.html','./print.html'+V,...styles,'./vendor/html2canvas.min.js'+V,'./vendor/jspdf.umd.min.js'+V,...ui,...seeds,...numbered('app',48),'./app-50.js'+V,'../apartments.js'+V,'./manifest.webmanifest'+V,'./icons/icon.svg'+V];
